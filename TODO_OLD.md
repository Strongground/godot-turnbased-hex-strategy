...
[x] Implement range finder method from red blob games blog to determine firing range, movement range etc. of entities.
[x] Add animations to the attack-mechanic.
[x] Make attacks reduce movement points and ammo of attacker.
[x] Implement effect on attacked unit
[x] Show useful information in GUI at all times.
